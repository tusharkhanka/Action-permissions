 ...
 */
public class PermissionRejectionExecutorDelegate extends BaseJavaDelegate {

	private static Log logger = LogFactory
			.getLog(PermissionRejectionExecutorDelegate.class);
	...
	public void execute(DelegateExecution execution) throws Exception {
		 ...
		 */
		String templatePATH = "PATH:\"/app:company_home/app:dictionary/app:email_templates/cm:EisenVault_Email_Templates/cm:potwf-rejected-email.html.ftl\"";
